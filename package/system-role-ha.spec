#
# spec file for package system-role-ha
#
...
#   https://github.com/yast/system-role-ha repository
#
...
Provides:       installer_module_extension() = system-role-ha

%description
Meta package for Server HA role definition.
